...
st.title("Prediction Model Using ANN")
st.title("Customer Churn Prediction")


# User input
geography = st.selectbox('Geography', g_geography_encoded.categories_[0])
...
geo_encoded = g_geography_encoded.transform([[geography]]).toarray()
